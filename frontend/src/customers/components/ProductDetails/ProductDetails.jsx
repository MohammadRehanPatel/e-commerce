...
export default function ProductDetails() {
  ...
  const currentCategory = products?.product?.category?.name;
  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="overflow-hidden rounded-lg max-w-[15rem] max-h-[13rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">56520 Ratings</p>
        ...
        {/* rating and review */}
        <section>
          <h1 className="font-semibold text-lg pt-10 pb-4">
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex space-x-3">
                  ...
                  <p className="opacity-60">56910 Ratings</p>
                </div>
        ...
        <section className="pt-10 ">
          <h1 className="py-5 text-xl font-semibold capitalize">
            Similar Products
          </h1>
